...
const SiSadar = () => {
    ...
    if (keywordValues.every(keyword => keyword === "")) {
        alert("Kamu harus isi minimal 1 kata kunci dulu sebelum generate judul");
        return;
    }
                ...
                <div>
                    <div className="row">
                        <div className="col-md-6">
                            <div className="mb-4">
                                <label htmlFor="" className="mb-2 clueless-kategori-title fs-4">Kata Kunci 1</label>
                                <input
                                    type="text"
                                    className="form-control form-control-lg "
                                    style={{  border: '3px solid #FF6B6B', fontSize: '18px'  }}
                                    id="k1"
                                    name="k1"
                            ...
                            <div className="mb-4">
                                <label htmlFor="" className="mb-2 clueless-kategori-title fs-4">Kata Kunci 2</label>
                                <input
                                    type="text"
                                    className="form-control form-control-lg "
                                    style={{  border: '3px solid #FF6B6B', fontSize: '18px'  }}
                            ...
                            <div className="mb-4">
                                <label htmlFor="" className="mb-2 clueless-kategori-title fs-4">Kata Kunci 3</label>
                                <input
                                    type="text"
                                    className="form-control form-control-lg"
                                    style={{  border: '3px solid #FF6B6B', fontSize: '18px'  }}
                        ...
                        <div className="col-md-6">
                            <div className="mb-4">
                                <label htmlFor="" className="mb-2 clueless-kategori-title fs-4">Kata Kunci 4</label>
                                <input
                                    type="text"
                                    className="form-control form-control-lg"
                                    style={{  border: '3px solid #FF6B6B', fontSize: '18px'  }}
                            ...
                            <div className="mb-4">
                                <label htmlFor="" className="mb-2 clueless-kategori-title fs-4">Kata Kunci 5</label>
                                <input
                                    type="text"
                                    className="form-control form-control-lg"
                                    style={{  border: '3px solid #FF6B6B', fontSize: '18px'  }}
                            ...
                            <div className="mb-4">
                                <label htmlFor="" className="mb-2 clueless-kategori-title fs-4" >Kata Kunci 6</label>
                                <input
                                    type="text"
                                    className="form-control form-control-lg"
                                    style={{  border: '3px solid #FF6B6B', fontSize: '18px'  }}
